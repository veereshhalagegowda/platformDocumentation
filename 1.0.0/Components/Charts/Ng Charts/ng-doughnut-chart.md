## Overview
Doughnut chart is similar to the pie chart but the different is doughnut chart has a circular hollow gap at the middle of the chart. This circular hollow gap is called as “cutoutPercentage” which represents what percentage of the inner should be cut out.
