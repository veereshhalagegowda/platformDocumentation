...
1. Input the component field(s) with the attribute value(s):
    ...
    ```
2. Save it and run.
3. When the page is loaded the value h1text = Heading 1, will be the heading that is displayed and "Class = h1" is the class name that can be used to point to a class in a style sheet.
