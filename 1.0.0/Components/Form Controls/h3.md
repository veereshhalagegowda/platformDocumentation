...
1. Input the component field with the attribute value:
    ...
    ```
2. Save it and run.
3. When the page is loaded the value h3text = Heading 3, will be the heading that is displayed. And "Class = h3" is the class name that can be used to point in a style sheet.
