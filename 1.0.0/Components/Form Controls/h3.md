...
1. Input the component field(s) with the attribute value(s):
    ...
    ```
2. Save it and run.
3. When the page is loaded the value H3 Text = Heading 3, will be the heading that is displayed and "Class = h3" is the class name that can be used to point in a style sheet.
