...
```
2. Save it and run.
3. When the page is loaded the value h2text = Heading 2, will be the heading that is displayed. And "Class = h2" is the class name that can be used to point in a style sheet.
